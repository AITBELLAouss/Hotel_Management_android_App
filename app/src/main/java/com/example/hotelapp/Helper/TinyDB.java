...
public class TinyDB {
    ...
    public String putImage(String theFolder ,String theImageName,Bitmap theBitmap ){
        ...
        String nfullPath = setupFullpath(theImageName);

        if (!nfullPath.equals("")){

            lastImagePath=nfullPath;
            saveBitmap(nfullPath,theBitmap);
    ...
    private String setupFullpath (String imageName){
        File nFolder = new File(Environment.getExternalStorageDirectory(),DEFAULT_APP_IMAGEDATA_DIRECTORY);

        if (isExternalStorageReadable() && isExternalStorageWritable() && !nFolder.exists()){
            if (!nFolder.mkdirs()){
                Log.e("Error","Failed to set up folder");
                return "";
            }
        }
        return nFolder.getPath()+'/'+imageName;
    }
    ...
    private String getString(String key) { return preferences.getString(key,""); }
